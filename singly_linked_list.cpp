...
void push_front(list_element * & head, int ile)
{
    ...
    p->next_element = head; // W polu next_element elementu umieszczamy adres przechowywany przez zmienną head. W ten sposób następnikiem nowego elementu stanie się obecny pierwszy element listy.
